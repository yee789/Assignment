    ...
    public void orderProcess(){
       ...
       Date date = new Date();
        ...
        do{            
            ...
            for(int i=0;i<m.size();i++){
                if(restaurant.equals(m.get(i).getRestaurant())){
                    ...
                    //String.format("%2s %4s %5s %6.2f",m.get(i).getMenuID(),m.get(i).getMenuName(),m.get(i).getMenuDescription(),m.get(i).getPrice());
                }
            }
        ...
        for(int i=0;i<m.size();i++){
            ...
            System.out.println("Enter (1) to view orderlist/Press enter to proceed.");
            String viewList = scan.nextLine();
